 ...
 */
export type Checkout = LemonSqueezyResponse<{
  attributes: {
    /**
 ...
 * @docs https://docs.lemonsqueezy.com/api/checkouts#the-checkout-object
 */
export type Checkouts = LemonSqueezyResponse<Array<Checkout["data"]>>;
...
export interface CreateCheckoutBody {
  data: {
    type: DataType.checkouts;
    attributes: Omit<CreateCheckoutParams, "store" | "variant">;
    relationships: {
      store: {
        data: {
          id: string;
          type: DataType.stores;
        };
      };
      variant: {
        data: {
          id: string;
          type: DataType.variants;
        };
      };
    };
  };
...
export interface CheckoutsParams {
  /**
